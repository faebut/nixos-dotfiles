...
hl.window_rule({ name = "photo-exe",  match = { class = "^(photo.exe)$" },          opacity = "1.0 override 1.0 override" })
hl.window_rule({ name = "nvim",       match = { title = "^nv(.*)$" },               opacity = "1.0 override 1.0 override" })
hl.window_rule({ name = "firefox",    match = { class = "^(firefox)$" },             opacity = "1.0 override 1.0 override" })
hl.window_rule({ name = "zen",        match = { class = "^(zen)$" },                 opacity = "1.0 override 1.0 override" })
hl.window_rule({ name = "win11-kvm",  match = { title = "^(Windows11 on QEMU/KVM)$"}, opacity = "1.0 override 1.0 override" })
...
hl.window_rule({ name = "border-dropterm",  match = { class = "^(kitty-dropterm)$" },            border_color = "rgb(41a6b5)" })
hl.window_rule({ name = "border-dropmc",    match = { class = "^(kitty-dropmc)$" },              border_color = "rgb(41a6b5)" })
hl.window_rule({ name = "border-pavuctl",   match = { class = "^(org.pulseaudio.pavucontrol)$" },border_color = "rgb(41a6b5)" })
hl.window_rule({ name = "border-spotify",   match = { class = "^(kitty-spotify)$" },             border_color = "rgb(41a6b5)" })
...
hl.bind(mainMod .. " + SHIFT + V",  hl.dsp.exec_cmd("rofi -modi clipboard:~/.config/rofi/scripts/clipboard -show clipboard -show-icons"))
...
hl.bind(mainMod .. " + XF86AudioRaiseVolume",  hl.dsp.exec_cmd("~/.config/hypr/scripts/volume.sh --mic-inc"), { repeating = true })
hl.bind(mainMod .. " + XF86AudioLowerVolume",  hl.dsp.exec_cmd("~/.config/hypr/scripts/volume.sh --mic-dec"), { repeating = true })
